...
class Goomba:
    ...
    def draw(self, surface):
        ...
        pygame.draw.rect(surface, WHITE, (self.x + self.width - 6*SCALE, 4*SCALE, 2*SCALE, 2*SCALE))
...
# Main game loop
async def main():
    global game_state, current_world, current_level, unlocked_worlds, score, coins, lives, time_left
